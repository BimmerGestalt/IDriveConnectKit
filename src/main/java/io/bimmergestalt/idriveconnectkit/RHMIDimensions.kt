...
/**
 * Handy reference to various screen displays and their dimensions
 */
 ...
 */
class SubsetRHMIDimensions(override val rhmiWidth: Int, override val rhmiHeight: Int):
	RHMIDimensions {
...
class GenericRHMIDimensions(override val rhmiWidth: Int, override val rhmiHeight: Int):
	RHMIDimensions {
	/*
 ...
 */
open class MiniDimensions(override val rhmiWidth: Int, override val rhmiHeight: Int):
	RHMIDimensions {
 ...
 */
class SidebarRHMIDimensions(val fullscreen: RHMIDimensions, val isWidescreen: () -> Boolean):
	RHMIDimensions {
